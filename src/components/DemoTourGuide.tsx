...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    pitchScript: '"Here is our signature interaction: The Scenario Lab. An officer can raise the compensation offer toward the Section 26 fair-market value and inspect the resulting risk curve. Sensitivity is monotonically constrained so higher compensation never increases risk; outputs stay DRAFT until calibrated on real timelines."',

module.exports = [
"[project]/src/data/documentVerificationData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/data/mockDataV7.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function generateHistoricalSnapshots(project) {
    ...
    for(let i = 0; i < 6; i++){
        ...
        snapshots.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataPipeline$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createTemporalSnapshot"])(historicalProject, historicalModel, triggerEvents[i]));
    }
    snapshots.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataPipeline$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createTemporalSnapshot"])(project, project.modelOutput, 'Current live state'));
    return snapshots;
}
const PROJECT_SNAPSHOTS = {};
__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"].forEach((project)=>{
    PROJECT_SNAPSHOTS[project.id] = generateHistoricalSnapshots(project);
});
const PROJECT_CASE_PULSES = {};
__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"].forEach((project)=>{
    PROJECT_CASE_PULSES[project.id] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataPipeline$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateCasePulse"])(project, PROJECT_SNAPSHOTS[project.id], __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_DECISION_LOGS"]);
});
const PIPELINE_RUNS = {};
__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"].forEach((project)=>{
    const runs = [];
    for(let i = 0; i < 3; i++){
        const run = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataPipeline$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPipelineRun"])(project.id, 'SIH_PROVIDED_DATASET', i === 0 ? 'MANUAL' : 'SCHEDULED');
        runs.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataPipeline$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["simulatePipelineRun"])(run, project));
    }
    PIPELINE_RUNS[project.id] = runs;
});
const REPLAY_STATES = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"].map((project)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataPipeline$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createReplayState"])(midSnapshot, actualOutcome);
});
const V7_DATA_PASSPORTS = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dataPipeline$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DATA_PASSPORTS"];
...
//# sourceMappingURL=src_data_1x1672w._.js.map